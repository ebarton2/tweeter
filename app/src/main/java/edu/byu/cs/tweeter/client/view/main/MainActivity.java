...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.MainView {
    ...
    @Override
    public void onStatusPosted(String post) { //TODO: Goes into a service
        presenter.postStatus(post);
    }

    @Override
    public void infoMessage(String message) {
        itemToast = Toast.makeText(this, message, Toast.LENGTH_LONG);
        itemToast.show();
    }
    ...
    @Override
    public void updateFollowButton(boolean toRemove) {
        if (toRemove) {
            followButton.setText(R.string.follow);
            followButton.setBackgroundColor(getResources().getColor(R.color.colorAccent));
        } else {
